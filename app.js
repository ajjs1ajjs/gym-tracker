...
function switchTab(tabId) {
  ...
  const activeBtn = document.querySelector(
    `.nav-item[onclick="switchTab('${tabId}')"]`,
  );
...
function openSettingsModal() {
  ...
  document.getElementById("github-token").value =
    localStorage.getItem("gym_github_token") || "";
  document.getElementById("gist-id").value =
    localStorage.getItem("gym_gist_id") || "";
}
...
function createLogbookCustomExercise() {
  LogbookModule.createExercise();
}
function loadLogbookSelect() {
  LogbookModule.loadSelect();
}
function renderLogbookSets() {
  LogbookModule.renderSets();
}
